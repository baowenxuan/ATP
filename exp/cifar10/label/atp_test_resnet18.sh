  ...
  for i in {0,1}; do
    {
      ...
      load_adapt_path="../history/cifar10/label/atp_${model}_pseed_${partition_seed}_seed_${seed}.pkl"
      load_adapt_idx=0
      load_adapt_round=-1

      history_path="../history/cifar10/label/atp_test_${tests[i]}_pseed_${partition_seed}_seed_${seed}.pkl"
